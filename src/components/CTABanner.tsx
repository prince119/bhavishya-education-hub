...
const CTABanner = () => (
  ...
  >
    ...
    <div className="container mx-auto px-4 text-center space-y-4 sm:space-y-6 relative z-10 max-w-full">
      <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-foreground">
        Are You Ready To Take The Next Step<br className="hidden md:block" /> In Your Career?
      </h2>
      <p className="text-sm sm:text-base text-secondary-foreground/80 max-w-xl mx-auto">
