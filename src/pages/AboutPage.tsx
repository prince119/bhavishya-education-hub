  ...
  <div className="min-h-screen overflow-hidden">
    ...
    <div className="relative py-12 sm:py-16" style={{ backgroundImage: `url(${headerImg})`, backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <h1 className="font-heading text-2xl sm:text-4xl font-bold text-secondary-foreground">About Us</h1>
        <p className="text-sm sm:text-base text-secondary-foreground/70 mt-2">Learn about Bhavishya Computer Education's mission and values</p>
      </div>
    </div>
